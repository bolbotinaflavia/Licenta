        ...
        private void DrawCharactersBounds()
        {
            ...
            //    Vector3 bottomRight = _mTransform.TransformPoint(new Vector3(characterInfo.bottomRight.x, characterInfo.bottomRight.y, 0));
               ...
               if (_mHandleSize < 0.5f)
               {
                   ...
                   // Ascent Line
                   var labelPosition = _mTransform.TransformPoint(new Vector3(center, ascentline, 0));
                   ...
                   //Handles.Label(labelPosition, "BaseLine (" + baselineMetrics.ToString("f3") + ")" , style);
            ...
            for (int i = 0; i < _mTextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    bool isCharacterVisible = characterIndex <= mTextComponent.maxVisibleCharacters &&
                                              ...
                                              (mTextComponent.overflowMode != TextOverflowModes.Page || currentCharInfo.pageNumber + 1 == mTextComponent.pageToDisplay);
        ...
        private void DrawLineBounds()
        {
            ...
            for (int i = 0; i < lineCount; i++)
            {
                ...
                if (_mHandleSize < 1.0f)
                {
                    ...
                    var labelPosition =
                        // Ascent Line
                        _mTransform.TransformPoint(new Vector3(lineBottomLeft, ascentline, 0));
