    ...
    public class CameraController : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if (cameraTarget != null)
            {
                ...
                // Using Smoothing
                _cameraTransform.position = movementSmoothing ? Vector3.SmoothDamp(_cameraTransform.position, _desiredPosition, ref _currentVelocity, movementSmoothingValue * Time.fixedDeltaTime) :
        ...
        private void GetPlayerInput()
        {
            ...
            if (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift) || touchCount > 0)
            {
                ...
                if (Mathf.Approximately(touchCount, 1) && Input.GetTouch(0).phase == TouchPhase.Moved)
                {
            ...
            if (Mathf.Approximately(touchCount, 2))
            {
